...
const Report = () => {
  ...
  const markdownComponents = {
    h1: ({ children }) => <h3 className="text-3xl font-semibold text-blue-700 mb-4">{children}</h3>,
    ...
    strong: ({ children }) => <span className="font-bold text-blue-600 text-base">{children}</span>,
  };

  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-blue-50 to-white px-8 py-16 flex items-center justify-center">
      <motion.div
        className="max-w-4xl w-full bg-white rounded-3xl shadow-3xl p-16 border border-blue-200"
      ...
      >
        ...
        <div className="text-center mb-12">
          <h2 className="text-5xl font-extrabold text-gray-800">
            <span className="text-blue-600">VitalAI</span> Health Report
          </h2>
        ...
        {reportData && reportData !== 'No report data available' ? (
          ...
          <div className="text-center text-red-600 bg-red-50 p-8 rounded-xl">
            ...
            <p className="mt-4 text-gray-600">You may have reached this page directly without submitting symptoms. Please go back and submit your symptoms first.</p>
          </div>
        )}
        ...
        <div className="mt-12">
          <button
            ...
            className="group flex items-center justify-center w-full bg-blue-600 hover:bg-blue-700 text-white py-5 rounded-xl font-semibold shadow-lg transition duration-300 transform hover:scale-105"
          >
